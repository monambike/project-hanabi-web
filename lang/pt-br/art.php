...
<html lang="pt-BR">
	<head>
		<title>PROJETO HANABI - ARTES</title>
		<!--Todos os metas-->
		<meta charset="utf-8"/>
			...
			<div style="background-color: rgba(255,255,255,0.85);">
				<header>
					...
					<nav id="nav_language">
						...
						<ul>
							<li>
								<a onmousedown="movelink('../pt-br/art.php')" class="txt_selected">BR</a>
								<span>|</span>
								<a onmousedown="movelink('../es-es/art.php')">ES</a>
							</li>
							<li>
								<a onmousedown="movelink('../ja-jp/art.php')">JP</a>
								<span style="margin-left: 3px;">|</span>
								<a onmousedown="movelink('../en-us/art.php')">EN</a>
							</li>
						</ul>
					</nav>
				</header>
				...
				<div id="div_sidebar_id" class="div_sidebar_class">
					...
					<a onmousedown="movelink('')" class="txt_selected">ARTES</a>
				...
				<nav id="nav_menu">
					<ul>
						...
						<li><a onmousedown="movelink()" class="txt_selected">ARTES</a></li>
				...
				<section>
					...
					<div class="div_content">
						<p>A aba 'artes' possui alguns desenhos que eu fiz. Se quiser, clique na imagem para ampliar.</p>
						<br>
						<br>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_1.jpeg">
								<img src="../../images/arts/art_1.jpeg">
							</a>
							<div class="div_description">Garota ensanguentada mergulhada em um tanque de água.</div>
						</div>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_2.jpeg">
								<img src="../../images/arts/art_2.jpeg">
							</a>
							<div class="div_description">Garota descansando ao ar livre.</div>
						</div>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_3.jpeg">
								<img src="../../images/arts/art_3.jpeg">
							</a>
							<div class="div_description">Prisioneira com uma arma na mão.</div>
						</div>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_4.jpeg">
								<img src="../../images/arts/art_4.jpeg">
							</a>
							<div class="div_description">O desenho que fiz de uma amiga.</div>
						</div>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_5.jpeg">
								<img src="../../images/arts/art_5.jpeg">
							</a>
							<div class="div_description">Uma releitura de uma skin da Wendy de Don't Starve.</div>
						</div>
						<div class="div_gallery">
							<a target="_blank" href="../../images/arts/art_6.png">
								<img src="../../images/arts/art_6.png">
							</a>
							<div class="div_description">Uma tentativa rápida de imitar a Emma no Paint.</div>
						</div>
					</div>
				</section>
